...
from cachi2.core.models.input import Request, _ExtraOptions, _SSLOptions
...
def _download(
    ...
    output_dir: Path,
    ssl_options: Optional[_SSLOptions] = None,
) -> dict[Path, Any]:
    """
...
def _get_ssl_context(ssl_options: _SSLOptions) -> ssl.SSLContext:
